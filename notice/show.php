...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8"><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
        ...
        <div class="section" >
            <div class="base">
                ...
                <?php
                    ...
                    $sql='update notice set hit=hit+1 where num = '.$_GET['num'].';';
                ...
                <div class="post" style=" padding-left: 3%;width : 80%; border-left: 2px solid rgb(242,93,46);  position:relative; float:left;">
                    ...
                    <div class="reply">
                        ...
                        <div class="create_reply">
                            ...
                            <?php
                            $sql= 'select * from notice_reply where parent = '.$_GET['num'].';';
                            $result = mysql_query($sql, $connect);
                            $counter=0;
