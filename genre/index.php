        ...
        <div class="section">
            <div class="base">
                <div class="selectbar">
                    <h2>장르별</h2>
                    <ul>
                        <li><a href="./index.php?mode=<?php  echo "고전"; ?>">고전문학</a></li>
                        <li><a href="./index.php?mode=<?php  echo "참고서"; ?>">참고서</a></li>
                        <li><a href="./index.php?mode=<?php  echo "사회과학"; ?>">사회/과학</a></li>
                        <li><a href="./index.php?mode=<?php  echo "소설"; ?>">소설</a></li>
                        <li><a href="./index.php?mode=<?php  echo "에세이"; ?>">에세이</a></li>
                    </ul>
                ...
                <div class="free">
                    ...
                    <?php
                    if(!isset($_GET['mode']))$_GET['mode'] = "고전";
                    ?>
...
<!-- class = 'table table-hover' -->
                            <tbody>
                                ...
                                $num_per_page = 5;
                                $row = mysql_fetch_row(mysql_query("select count(*) from book where genre = '$_GET[mode]' "));
                                $total_record = $row[0];//게시물 총 갯수
                                $offset = $num_per_page*($_GET['page']-1);
                                $total_page = ceil($total_record/$num_per_page);
                                $article_num = $total_record - $num_per_page*($_GET['page']-1);
                                $sql= "select * from book where genre = '".$_GET['mode']."'  limit $offset,$num_per_page;;";
