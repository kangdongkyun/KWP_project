        ...
        <div class="section">
            <div class="base">
                <div class="selectbar" style="">
                    <ul>
                        <li><a href="../basket/index.php">장바구니</a></li>
                        <li><a href="./index.php">구매내역</a></li>
                    </ul>
                </div>
                    ...
                    <div class="list">
                        ...
                        <table class = 'table table-hover' style="width:80%;">
                            ...
                            <tbody>
                                <?php
                                    include "../dbconn.php";
                                    $sql2 = "select book.name AS bookName, book.price AS price, purchase.quantity AS quantity,book.path_img AS Img from book, purchase where book.num=purchase.book_num and purchase.user_id = '".$_SESSION['id']."';";
                                    $result = mysql_query($sql2, $connect);
                                    while($row = mysql_fetch_array($result))
                                    {   echo " <tr>";
                                        echo "<td class=\"data\"><img src=\".$row[Img]\" style=\"width:20%;\"> $row[bookName]</td>";
